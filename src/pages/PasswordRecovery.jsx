    ...
    <>
      <div className="flex flex-col  items-center h-[1000px]">
        ...
        <div className={`${style.form} gap-4`}>
          <h2 className={`${style.PasswordRecoveryHeading} `}>
            Recover Password
          </h2>
          <h3 className={`${style.smallText} font-thin `}>
            We will be sending you a reset password link to your email.
          </h3>
          <form onSubmit={handleSubmit} className="flex flex-col gap-7 mt-10">
            ...
            <div className="form-group">
              <div className="relative">
                ...
                <label htmlFor="username" className={`${style.inputLabels}`}>
                  Username / Email
                </label>
              </div>
            </div>
