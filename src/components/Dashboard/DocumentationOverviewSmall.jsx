...
function DocumentationOverviewSmall() {
  ...
  return (
    <div className="flex flex-col space-y-4 rounded-3xl w-full p-4">
        <div className="flex flex-col ">
          <h1 className="text-[26px] font-poppins font-semibold text-left ml-5 dark:text-textWhite text-textBlack">Documentation Overview</h1>
