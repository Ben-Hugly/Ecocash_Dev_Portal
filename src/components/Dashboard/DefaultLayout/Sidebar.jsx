    ...
    <div className="bg-white dark:bg-darkBgComponents flex flex-col p-4 h-full">
      ...
      <div className="mt-5 border-b border-t border-borderLight dark:border-borderBlue">
        <ul className="space-y-3 font-poppins text-lg py-2">
          <li
            className={`hover:bg-componentsBackgroundLight dark:hover:bg-darkBgHover hover:scale-105 hover:rounded-2xl ${
              overviewActive
                ? "bg-componentsBackgroundLight dark:bg-darkBgHover rounded-3xl"
                : ""
            }`}
          ...
          >
            ...
            >
              ...
              <GoHomeFill size={18} color="#035AA9" />
              <span className="text-[14px] font-poppins text-textBlack dark:text-white">
                Overview
              </span>
            </Link>
          </li>
          <li
            className={`hover:bg-componentsBackgroundLight dark:hover:bg-darkBgHover hover:rounded-2xl ${
              myAppsActive
                ? "bg-componentsBackgroundLight dark:bg-darkBgHover rounded-3xl"
                : ""
            }`}
          ...
          >
            ...
            >
              ...
              <MdFolderSpecial size={18} color="#035AA9" />
      ...
      >
        <Link
          ...
          className={`flex items-center space-x-2 px-2 py-5 pr-7 hover:bg-componentsBackgroundLight dark:hover:bg-darkBgHover hover:scale-105 hover:rounded-2xl w-full ${
            documentationActive
              ? "bg-componentsBackgroundLight dark:bg-darkBgHover rounded-3xl"
              : ""
          }`}
        >
          ...
          <IoDocumentText size={18} color="#035AA9" />
          <span className="text-[14px] font-poppins text-gray-900 dark:text-white">
            Documentation
          </span>
        </Link>
      ...
      <div className="bg-componentsBackgroundLight dark:bg-backgroundDark rounded-2xl p-4">
        <Link
          to="/dashboard/documentation"
          className="flex items-center space-x-3 px-2 py-2 border-b border-borderLight w-full hover:bg-componentsBackgroundLight dark:border-borderBlue dark:hover:bg-darkBgHover hover:rounded-3xl hover:scale-110"
        >
        ...
        <button
          className="flex items-center space-x-3 space-y-2 px-2 py-4 border-b border-borderLight w-full hover:scale-110 justify-between hover:bg-componentsBackgroundLight dark:border-borderBlue dark:hover:bg-darkBgHover hover:rounded-3xl"
        ...
        {isDevToolsOpen && (
          <div className="pl-1 mt-5 space-y-5">
            <Link
              ...
              className="flex text-[13px] font-poppins text-gray-900 dark:text-white hover:bg-componentsBackgroundLight dark:hover:bg-darkBgHover items-center space-x-3 px-2 space-y-2 py-4 w-full rounded-2xl"
            >
              Build Your Integration
            </Link>
            <Link
              to="/dashboard/documentation/dev/c2b"
              className="flex text-[14px] font-poppins text-gray-900 dark:text-white hover:bg-componentsBackgroundLight dark:hover:bg-darkBgHover items-center space-x-3 px-2 py-2 w-full rounded-2xl"
            >
              C2B
            </Link>
            <Link
        ...
        <button
          className="flex items-center space-x-3 px-2 py-2 w-full justify-between rounded-2xl hover:bg-componentsBackgroundLight dark:border-borderBlue dark:hover:bg-darkBgHover hover:rounded-3xl hover:scale-110"
